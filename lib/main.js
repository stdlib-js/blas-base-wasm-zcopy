...
/**
* WebAssembly module to copy values from one double-precision complex floating-point vector to another double-precision complex floating-point vector.
*
* @name zcopy
* @type {Routine}
*
...
setReadOnly( zcopy, 'Module', Module.bind( null ) );
