...
var V=require('@stdlib/assert-is-wasm-memory/dist'),m=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),g=require('@stdlib/utils-inherit/dist'),w=require('@stdlib/wasm-module-wrapper/dist'),j=require('@stdlib/error-tools-fmtprodmsg/dist'),D=h();function u(e){if(!(this instanceof u))return new u(e);if(!V(e))throw new TypeError(j('nullH0',e));return w.call(this,D,e,{env:{memory:e}}),this}g(u,w);m(u.prototype,"main",function(r,s,i,a,t){return this._instance.exports.c_zcopy(r,s,i,a,t),a});m(u.prototype,"ndarray",function(r,s,i,a,t,c,p){return this._instance.exports.c_zcopy_ndarray(r,s,i,a,t,c,p),t});M.exports=u
